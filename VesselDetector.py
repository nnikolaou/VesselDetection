...
for run in range(n_runs):
    ...
    ##Renormalize:
    #X_train = X_train / np.nanmax(X_train)
...
print("-------Asymmetry:-------")
print("Expected Accuracy: "+str(avg_Expected_Accuracy)+"+/-"+str(std_Expected_Accuracy/np.sqrt(n_runs))+", i.e. if we were randomly assigning examples.")
